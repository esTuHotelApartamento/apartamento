...
const HabitacionSuitPage = () => {
  ...
  return (
    <>
      <SEO title="Habitación Suit" />
      <Section>
        <ImageHead src="/habitaciones/habitaciones-suit/hs2.jpg" alt="Image" />
        <ContainerTexto>

          <TitleRoom>Habitación Triple</TitleRoom>
          <DescRoom>
...
export default HabitacionSuitPage
